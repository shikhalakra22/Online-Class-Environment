...
SECRET_KEY = 'ci$4itcll)3=^y3$a)@yy088a$*b0l%79a22w02gx^h482*(c2'

DEBUG = False

ALLOWED_HOSTS = ['roomfiles.herokuapp.com','onlineclassenv.herokuapp.com','localhost']
...
# GDrive Settings
GOOGLE_DRIVE_STORAGE_JSON_KEY_FILE = '/home/shikha/Videos/onlineclass/clean-evening-294718-7f1e27b4e1dc.json'
